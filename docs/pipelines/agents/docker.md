...
If you want a fresh agent container for every pipeline run, you should uncomment out the '--once' flag for run.cmd in the start.ps1 file, then Build the Image again (part 5 above).
